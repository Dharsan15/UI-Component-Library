...
function SideList({ value, selected, setSelected }) {
  ...
  return (
    <button
      ...
      } flex w-full items-center p-2 pl-6 rounded-lg hover:bg-gray-100 hover:underline group`}
    >
      {value}
    </button>
  );
...
const values = ["Accordian", "Alert", "Buttons", "Cards", "Notification", "Input", "component7"];
